 ...
 * @returns {any}
 */
export function normalize_graph_spec_json(json) {
    const ptr0 = passStringToWasm0(json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.normalize_graph_spec_json(ptr0, len0);
    if (ret[2]) {
...
const VizijOrchestratorFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_vizijorchestrator_free(ptr >>> 0, 1));
...
export class VizijOrchestrator {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        VizijOrchestratorFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_vizijorchestrator_free(ptr, 0);
    }
    /**
     ...
     * @param {number} dt
     * @param {bigint | null} [since_version]
     * @returns {any}
     */
    step_delta(dt, since_version) {
        const ret = wasm.vizijorchestrator_step_delta(this.__wbg_ptr, dt, !isLikeNone(since_version), isLikeNone(since_version) ? BigInt(0) : since_version);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    export_graph(id) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.vizijorchestrator_export_graph(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    remove_graph(id) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.vizijorchestrator_remove_graph(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
    ...
    remove_input(path) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.vizijorchestrator_remove_input(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
     ...
     */
    replace_graph(cfg) {
        const ret = wasm.vizijorchestrator_replace_graph(this.__wbg_ptr, cfg);
        if (ret[1]) {
    ...
    register_graph(cfg) {
        ...
        let deferred2_1;
        try {
            const ret = wasm.vizijorchestrator_register_graph(this.__wbg_ptr, cfg);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
     ...
     */
    list_controllers() {
        const ret = wasm.vizijorchestrator_list_controllers(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    remove_animation(id) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.vizijorchestrator_remove_animation(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
    ...
    register_animation(cfg) {
        ...
        let deferred2_1;
        try {
            const ret = wasm.vizijorchestrator_register_animation(this.__wbg_ptr, cfg);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
    ...
    register_merged_graph(cfg) {
        ...
        let deferred2_1;
        try {
            const ret = wasm.vizijorchestrator_register_merged_graph(this.__wbg_ptr, cfg);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
     ...
     */
    constructor(opts) {
        const ret = wasm.vizijorchestrator_new(opts);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        VizijOrchestratorFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     */
    step(dt) {
        const ret = wasm.vizijorchestrator_step(this.__wbg_ptr, dt);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    prebind(resolver) {
        wasm.vizijorchestrator_prebind(this.__wbg_ptr, resolver);
    }
    /**
     ...
     * @param {string} path
     * @param {any} value_json
     * @param {any} shape_json
     */
    set_input(path, value_json, shape_json) {
        const ptr0 = passStringToWasm0(path, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.vizijorchestrator_set_input(this.__wbg_ptr, ptr0, len0, value_json, shape_json);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('vizij_orchestrator_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
