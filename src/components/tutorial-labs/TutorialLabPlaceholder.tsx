...
import { ArrowRight, CheckCircle, PlayCircle } from "@solar-icons/react-perf/LineDuotone";
				...
				<div className="space-y-5">
					<div className="rounded-2xl border border-accent-base/20 bg-surface-lighter/50 p-6">
						<div className="flex items-center gap-3 text-accent-two">
							...
							<p className="text-sm font-semibold uppercase tracking-[0.2em]">Try this</p>
						</div>
					...
					<div className="rounded-2xl border border-accent-base/20 bg-special-lighter/70 p-6">
						<div className="flex items-center gap-3 text-accent-two">
							...
							<p className="text-sm font-semibold uppercase tracking-[0.2em]">Success signal</p>
						</div>
						<p className="mt-4 text-sm leading-6 text-color-500">{successSignal}</p>
						{note ? <p className="mt-4 text-sm leading-6 text-color-500">{note}</p> : null}
					</div>
				</div>
				<div>
					{children ?? (
