...
export function PoseButtonPanel({
		...
		return (
			...
			>
				...
				<p className="mt-2 text-sm text-color-500">
					Load a rig bundle with pose definitions to unlock instant expression triggers.
				</p>
			</div>
		);
	}
	...
	return (
		...
		>
			...
			<p className="mt-2 text-sm text-color-500">
				Buttons map straight to Vizij pose weights. Hotkeys mirror each button so you can rehearse
				and perform live.
			</p>
