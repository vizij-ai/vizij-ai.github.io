...
id: quori-v1
name: Quori v1
description: A modular, affordable socially interactive robot platform developed
  for enabling human-robot interaction research. Features an expressive
  projected face, gesturing arms with shoulder-like articulation, flexible
  spine, and omnidirectional mobility.
shortDescription: Modular social robot platform for HRI research with projected
  face and expressive gestures
category: social
status: deprecated
images:
...
specifications:
  ...
  sensors:
    ...
    - Proximity sensors
  actuators:
    - 2 DOF shoulder joints per arm
    - Omnidirectional base motors
    - Spine articulation motors
