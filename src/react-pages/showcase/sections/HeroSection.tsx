...
export function HeroSection({ copy }: { copy?: SectionCopy }) {
	...
	const title = copy?.title ?? "Design, animate, and deploy expressive rendered robot faces.";
	...
	const ctaSecondaryHref = copy?.ctaSecondaryHref ?? "https://github.com/vizij-ai";
	...
	return (
		<section id="hero" className="showcase-section showcase-section--hero" ref={ref}>
			<div className="hero-header">
				...
				<div className="section-header">
					...
					{headerDescription && <p className="section-description">{headerDescription}</p>}
						...
						<button
							...
							onClick={() =>
								ctaPrimaryHref.startsWith("#")
									...
									: // biome-ignore lint/suspicious/noAssignInExpressions: intentional navigation assignment in ternary
										(window.location.href = ctaPrimaryHref)
							}
						>
							{ctaPrimaryLabel}
						</button>
						<a className="ghost-button" href={ctaSecondaryHref} target="_blank" rel="noreferrer">
							{ctaSecondaryLabel}
						</a>
						<a
