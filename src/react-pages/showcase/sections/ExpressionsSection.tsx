		...
		<div className="expression-panel-shell">
			<div className="feature-card feature-card--placeholder">
				...
				<p className="feature-card__description">
					We spin up a dedicated Vizij runtime per section, so this panel awakens once it reaches
					the viewport.
				</p>
...
function ExpressionFaceFallback({ label, subtitle }: ExpressionFaceFallbackProps) {
	return <FaceFramePlaceholder variant="md" label={label} subtitle={subtitle} />;
}
