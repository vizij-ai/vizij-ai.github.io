import SectionBlock, { type SectionVariant } from "@/components/sections/SectionBlock";
import { LinkCard } from "@semio-community/ecosystem-site-core";
import { CodeSquare, CpuBolt, TestTube } from "@solar-icons/react-perf/LineDuotone";
...
export default function ProgramsSection({
	...
	return (
		...
		>
			...
			{children ? (
				<div className="prose prose-citrus max-w-none text-center">{children}</div>
			) : null}
		</SectionBlock>
	);
}
