...
const defaultPrimaryCopy = (
	<>
		Semio Community is a <span className="font-semibold">501(c)(3) nonprofit organization</span>{" "}
		facilitating community-driven robotics hardware, software, and research to foster reproducible,
		replicable, and generalizable science and reusable systems within human-robot interaction (HRI).
	</>
);
...
const defaultFeatures: MissionSectionProps["features"] = [
	{
		...
		icon: (
			<HugeiconsIcon icon={UserMultipleIcon} className="w-12 h-12 mx-auto mb-3 text-accent-two" />
		),
	...
	},
	{
		title: "Replicable",
		icon: (
			<HugeiconsIcon icon={BookOpen01Icon} className="w-12 h-12 mx-auto mb-3 text-accent-two" />
		),
...
const defaultSecondaryCopy = (
	<>
		Founded with the belief that the future of robotics lies in collaborative innovation, we work to
		break down barriers between research and application, making cutting-edge robotics technology
		accessible to researchers, developers, and educators worldwide.
	</>
);
