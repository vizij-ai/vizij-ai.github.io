...
const DEMOS_INDEX_HREF = url("/demos/");
const DOCS_INDEX_HREF = url("/docs/");
const DOCS_ARCHITECTURE_HREF = url("/docs/architecture/");
const DOCS_RENDERER_DATA_MODEL_HREF = url("/docs/renderer-data-model/");
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-[1.25fr_0.95fr]">
        <div className="space-y-5">
          <div>
            ...
            <p className={`mt-2 text-sm leading-7 ${MUTED_TEXT_CLASS}`}>
              {summary}
            </p>
          </div>
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
            <div className={TEACHING_CARD_CLASS}>
              ...
              <ul
                className={`mt-4 space-y-3 text-sm leading-6 ${MUTED_TEXT_CLASS}`}
              >
                {bullets.map((bullet) => (
          ...
          <div className={TEACHING_CARD_CLASS}>
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              {sources.map((source) => (
                <a
                  key={source.href}
                  href={resolveSitePath(source.href)}
      ...
      <div className="grid gap-8 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-end">
        <div className="space-y-6 rounded-[2.35rem] border border-[#ead7c3] bg-[linear-gradient(180deg,rgba(255,251,245,0.98),rgba(247,239,229,0.93))] p-6 shadow-[0_20px_64px_-34px_rgba(24,24,27,0.24)] dark:border-white/10 dark:bg-[linear-gradient(180deg,rgba(22,25,31,0.96),rgba(16,18,23,0.92))] dark:shadow-[0_20px_64px_-34px_rgba(0,0,0,0.6)] sm:p-8">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <span
              className={HERO_SUBTLE_PILL_CLASS}
              style={{ fontFamily: SANS_STACK }}
            >
              Observe, inspect, reproduce
            </span>
          ...
          <div className="space-y-4">
            ...
            <p
              ...
              style={{ fontFamily: SANS_STACK }}
            >
              Browse each runtime surface as its own page so the behavior, code
              path, and follow-on route stay focused instead of competing inside
              one long scroll document.
            </p>
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className={SOFT_PANEL_CLASS}>
              ...
              <p
                ...
                style={{ fontFamily: SERIF_STACK }}
              >
                Choose one behavior, then move straight into its runtime
                contract
              </p>
            </div>
            ...
            <div className="flex items-center justify-between gap-3 border-b border-white/8 bg-white/5 px-5 py-4">
              <div>
                ...
                <p
                  ...
                  style={{ fontFamily: SANS_STACK }}
                >
                  The demos index should prove inspectability immediately, then
                  route you into the specific runtime surface you want to study.
                </p>
              </div>
              <span
...
standard/vizij/jaw/open -> { f64: 0.15 }`}
          ...
          <div className="flex flex-wrap gap-3">
            ...
            />
            <DemoActionButton
              href={DOCS_INDEX_HREF}
              label="Read Docs"
              variant="secondary"
            />
            <DemoActionButton
              href={DOCS_ARCHITECTURE_HREF}
      ...
      <div className="grid gap-8 lg:grid-cols-[minmax(0,0.88fr)_minmax(0,1.12fr)]">
        <div className="space-y-6 rounded-[2.35rem] border border-[#ead7c3] bg-[linear-gradient(180deg,rgba(255,251,245,0.98),rgba(247,239,229,0.93))] p-6 shadow-[0_20px_64px_-34px_rgba(24,24,27,0.24)] dark:border-white/10 dark:bg-[linear-gradient(180deg,rgba(22,25,31,0.96),rgba(16,18,23,0.92))] dark:shadow-[0_20px_64px_-34px_rgba(0,0,0,0.6)] sm:p-8">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            />
            <DemoActionButton
              href={DEMOS_INDEX_HREF}
              label="Browse All Demos"
              variant="tertiary"
            />
          </div>
        </div>
        ...
        <div className={SOFT_PANEL_CLASS}>
          ...
          <p
            ...
            style={{ fontFamily: SANS_STACK }}
          >
            The behavior pages replace the old scroll-jump menu. Pick another
            runtime surface here when you want to compare contracts side by
            side.
          </p>
          <div className="mt-5">
    ...
    >
      ...
      <div className="mx-auto max-w-6xl">
        <DemoTeachingPanel
          ...
          code={
            "setInput(`rig/${faceId}/poses/${poseId}.weight`, { float: 1 });"
          }
          sources={[
            {
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto mt-8 grid max-w-5xl grid-cols-1 gap-4 md:grid-cols-3">
        ...
        <CallToActionButton
          href={url("/docs/renderer-data-model/")}
          size="large"
          variant="tertiary"
          fullWidth
        >
      ...
      <div className="grid gap-5 lg:grid-cols-[minmax(0,0.7fr)_minmax(0,0.3fr)]">
        ...
        <div className={SOFT_PANEL_CLASS}>
          ...
          <p
            ...
            style={{ fontFamily: SANS_STACK }}
          >
            Route back to the full demos index or jump into the underlying docs
            and tutorials when you want the implementation contract instead of
            the preview.
          </p>
