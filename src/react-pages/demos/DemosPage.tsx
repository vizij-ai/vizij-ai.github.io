	...
	return (
		<OrchestratorProvider autostart={false}>
			<HeroHeader
				...
				title="Demos"
				description="Explore the Vizij runtime through sectioned demos for passive behavior, rig controls, expressions, gaze interactions, and voice lip-sync."
				actions={[
			...
			<Section
				id="hero"
				title="Overview"
				subtitle="Two runtime instances showing passive behavior with separate rig bundles."
				variant="secondary"
			>
					...
					{HERO_FACES.map((face, index) => (
						<article key={face.namespace} className={PREVIEW_CARD_CLASS}>
							...
							<div className="flex flex-col gap-1 p-5">
								...
								<p className="text-sm text-color-500">{face.subtitle}</p>
							</div>
						</article>
					))}
				</div>
					...
					<div className="mx-auto grid max-w-6xl grid-cols-1 gap-6 md:grid-cols-2">
						{controlsView.hasEntered ? (
							...
							<>
								...
								<article className={PREVIEW_CARD_CLASS}>
									<div className="p-5 text-sm text-color-500">Scroll to load rig controls.</div>
								</article>
							</>
						)}
					</div>
						...
						{expressionsView.hasEntered ? (
									...
									>
										...
										<article className={PREVIEW_CARD_CLASS}>
											...
											<div className="flex flex-col gap-1 p-5">
												...
												<p className="text-sm text-color-500">{face.description}</p>
											</div>
										</article>
									</ShowcaseRuntime>
								))}
							...
							<>
								...
								<article className={PREVIEW_CARD_CLASS}>
									...
									<div className="p-5 text-sm text-color-500">Scroll to load Quori preview.</div>
								</article>
								<article className={PREVIEW_CARD_CLASS}>
									<div className={PREVIEW_MEDIA_CLASS}>
										<FaceFramePlaceholder
									...
									<div className="p-5 text-sm text-color-500">Scroll to load Hugo preview.</div>
								</article>
							</>
						)}
					</div>
					...
					<div className="mx-auto max-w-6xl">
						{gazeView.hasEntered ? (
							...
							>
								<article className={PREVIEW_CARD_CLASS}>
									<div className={PREVIEW_MEDIA_CLASS}>
										<GazeInteractiveFace enabled={gazeView.isVisible} mode="media" />
									</div>
									<div className="flex flex-col gap-1 p-5">
										<p className="text-xs font-semibold uppercase tracking-wider text-accent-base/80">
										...
										<p className="text-sm text-color-500">
											Move the pointer to steer gaze. Click the face for random expression
											reactions.
										</p>
									</div>
								</article>
							...
							<article className={PREVIEW_CARD_CLASS}>
								...
								<div className="p-5 text-sm text-color-500">Scroll to load gaze interactions.</div>
							</article>
						)}
					</div>
				</Section>
						...
						{voiceView.hasEntered ? (
							...
							<>
								<article className={PREVIEW_CARD_CLASS}>
									...
									<div className="p-5 text-sm text-color-500">Scroll to load voice preview.</div>
								</article>
								<article className={PREVIEW_CARD_CLASS}>
									<div className="p-5 text-sm text-color-500">Scroll to load voice controls.</div>
								</article>
							</>
						)}
					</div>
