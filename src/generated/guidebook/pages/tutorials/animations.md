---
pageId: tutorials-animations
moduleId: tutorials/animations
sourceModuleId: customize/animations
sourcePath: customize/animations.md
surface: tutorials
publish: true
routeSlug: animations
canonicalPath: /tutorials/animations/
routeRole: walkthrough
routeRoleLabel: Motion branch
title: Animations
summary: Understand the authored motion branch before you move into live
  integrations and heavier runtime behavior.
...
prev:
  ...
  description: Return to the smallest runtime shell.
next:
  label: Agent Face
  href: /tutorials/agent-face/
  description: Continue into the richer API-backed integration branch.
implementationAnchors:
  - label: Animation reference bridge
    ...
    description: Reference bridge for later-stage motion and runtime delivery.
demoLinks: []
hasMermaid: true
---
